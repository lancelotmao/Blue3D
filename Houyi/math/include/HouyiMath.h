...
#ifndef Houyi_HouyiMath_h
#define Houyi_HouyiMath_h
    ...
    public:
       ...
       */
		...
		*/
        ...
        static inline float min(float n1, float n2, float n3)
        {
        ...
        static bool rayTriangleIntersect(Vector3& res, Vector3 p, Vector3 d, Vector3 v0, Vector3 v1, Vector3 v2);
