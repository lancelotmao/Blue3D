...
#include "HouyiRay.h"
#include "HouyiSphere.h"
#include "HouyiAxisAlignedBox.h"
...
#undef _CALC_AXIS
    ...
    //---------------------------------------------------------------------
    bool Math::rayTriangleIntersect(Vector3& res, Vector3 p, Vector3 d, Vector3 v0, Vector3 v1, Vector3 v2)
    {
        float a,f,u,v;
        Vector3 e1 = v1 - v0;
        Vector3 e2 = v2 - v0;
        
        Vector3 h = d.crossProduct(e2);
        a = e1.dotProduct(h);
